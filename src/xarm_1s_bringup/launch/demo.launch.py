"""
xArm 1S 메인 bringup launch.

  - use_mock:=true   → 시뮬레이션(mock_components/GenericSystem)
  - use_mock:=false  → 실제 로봇(xarm_1s_hardware, USB HID)

ros2_control / MoveIt2 / RViz 를 한 번에 띄운다.
...
def generate_launch_description():
    moveit_pkg = "xarm_1s_moveit_config"
    ...
    moveit_config = (
        MoveItConfigsBuilder("xarm_1s_moveit_config", package_name=moveit_pkg)
